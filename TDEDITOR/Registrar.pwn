...
//Textdraws
PublicTD[0] = TextDrawCreate(345.000000, 109.000000, "RP");
...
PlayerTD[playerid][13] = CreatePlayerTextDraw(playerid, 273.000000, 137.000000, "Registro");
...
PlayerTD[playerid][14] = CreatePlayerTextDraw(playerid, 317.000000, 242.000000, "_");
PlayerTextDrawFont(playerid, PlayerTD[playerid][14], 1);
PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][14], 0.600000, 1.850000);
PlayerTextDrawTextSize(playerid, PlayerTD[playerid][14], 298.500000, 135.000000);
...
PlayerTD[playerid][15] = CreatePlayerTextDraw(playerid, 252.000000, 244.000000, "Confirmar Senha");
PlayerTextDrawFont(playerid, PlayerTD[playerid][15], 1);
PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][15], 0.375000, 1.350001);
PlayerTextDrawTextSize(playerid, PlayerTD[playerid][15], 382.500000, 168.000000);
...
PlayerTextDrawBoxColor(playerid, PlayerTD[playerid][15], -1094795521);
